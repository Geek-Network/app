...
export const SPELL = new Token(ChainId.AVALANCHE, '0xCE1bFFBD5374Dac86a2893119683F4911a2F7814', 18, 'SPELL', 'Spell Token');
export const TIME = new Token(ChainId.AVALANCHE, '0xb54f16fB19478766A268F172C9480f8da1a7c9C3', 9, 'TIME', 'Time');

export const WMEMO = new Token(ChainId.AVALANCHE, '0x0da67235dD5787D67955420C84ca1cEcd4E5Bb3b', 18, 'WMEMO', 'Wrapped MEMO');
...
export const STG = new Token(ChainId.AVALANCHE, '0x2F6F07CDcf3588944Bf4C42aC74ff24bF56e7590', 18, 'STG', 'StargateToken');
