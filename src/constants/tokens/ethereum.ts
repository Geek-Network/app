...
export const DOUGH = new Token(ChainId.ETHEREUM, '0xad32A8e6220741182940c5aBF610bDE99E737b2D', 18, 'DOUGH', 'PieDAO Dough v2');
export const DUCK = new Token(ChainId.ETHEREUM, '0x92E187a03B6CD19CB6AF293ba17F2745Fd2357D5', 18, 'DUCK', 'DUCK');
export const ETH2X_FLI = new Token(ChainId.ETHEREUM, '0xAa6E8127831c9DE45ae56bB1b0d4D4Da6e5665BD', 18, 'ETH2x-FLI', 'ETH 2x Flexible Leverage Index');
...
export const IBETH = new Token(ChainId.ETHEREUM, '0xeEa3311250FE4c3268F8E684f7C87A82fF183Ec1', 8, 'ibETHv2', 'Interest Bearing Ether v2');
...
export const PLAY = new Token(ChainId.ETHEREUM, '0x33e18a092a93ff21aD04746c7Da12e35D34DC7C4', 18, 'PLAY', 'Metaverse NFT Index');
export const PONT = new Token(ChainId.ETHEREUM, '0xcb46C550539ac3DB72dc7aF7c89B11c306C727c2', 9, 'pONT', 'Poly Ontology Token');
export const PWING = new Token(ChainId.ETHEREUM, '0xDb0f18081b505A7DE20B18ac41856BCB4Ba86A1a', 9, 'pWING', 'Poly Ontology Wing Token');
...
export const UMA_CALL = new Token(ChainId.ETHEREUM, '0x1062aD0E59fa67fa0b27369113098cC941Dd0D5F', 18, 'UMA', 'UMA 35 Call [30 Apr 2021]');
export const USDC = new Token(ChainId.ETHEREUM, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 6, 'USDC', 'USD Coin');
export const USDP = new Token(ChainId.ETHEREUM, '0x1456688345527bE1f37E9e627DA0837D6f08C925', 18, 'USDP', 'USDP Stablecoin');
...
export const XSUSHI_CALL = new Token(ChainId.ETHEREUM, '0xada279f9301C01A4eF914127a6C2a493Ad733924', 18, 'XSUc25-0531', 'XSUSHI 25 Call [31 May 2021]');
export const WBTC = new Token(ChainId.ETHEREUM, '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599', 8, 'WBTC', 'Wrapped BTC');
export const XSUSHI = new Token(ChainId.ETHEREUM, '0x8798249c2E607446EfB7Ad49eC89dD1865Ff4272', 18, 'xSUSHI', 'SushiBar');
export const LIFT = new Token(ChainId.ETHEREUM, '0xf9209d900f7ad1DC45376a2caA61c78f6dEA53B6', 18, 'LIFT', 'LiftKitchen');
export const LFBTC = new Token(ChainId.ETHEREUM, '0xafcE9B78D409bF74980CACF610AFB851BF02F257', 18, 'LFBTC', 'LiftKitchen BTC');
...
export const CRXSUSHI = new Token(ChainId.ETHEREUM, '0x228619CCa194Fbe3Ebeb2f835eC1eA5080DaFbb2', 8, 'crXSUSHI', 'Cream SushiBar');
export const AXSUSHI = new Token(ChainId.ETHEREUM, '0xF256CC7847E919FAc9B808cC216cAc87CCF2f47a', 18, 'aXSUSHI', 'Aave interest bearing XSUSHI');
export const DPI = new Token(ChainId.ETHEREUM, '0x1494CA1F11D487c2bBe4543E90080AeBa4BA3C2b', 18, 'DefiPulse', 'DPI');
export const RAI = new Token(ChainId.ETHEREUM, '0x03ab458634910AaD20eF5f1C8ee96F1D6ac54919', 18, 'Rai Reflex Index', 'RAI');
...
export const DOLA = new Token(ChainId.ETHEREUM, '0x865377367054516e17014CcdED1e7d814EDC9ce4', 18, 'Dola USD Stablecoin', 'DOLA');
export const MIM = new Token(ChainId.ETHEREUM, '0x99D8a9C45b2ecA8864373A26D1459e3Dff1e17F3', 18, 'MIM', 'Magic Internet Money');
export const SPELL = new Token(ChainId.ETHEREUM, '0x090185f2135308BaD17527004364eBcC2D37e5F6', 18, 'SPELL', 'Spell Token');
