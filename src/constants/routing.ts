...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
    ...
    [ChainId.MATIC]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC], MATIC.USDC, MATIC.WBTC, MATIC.DAI, MATIC.WETH, MATIC.USDT, MATIC.MIM, MATIC.SUSHI, MATIC.FRAX, MATIC.STG],
    [ChainId.MATIC_TESTNET]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC_TESTNET], new Token(ChainId.MATIC_TESTNET, '0x742DfA5Aa70a8212857966D491D67B09Ce7D6ec7', 6, 'USDC', 'USD Coin')],
    [ChainId.RINKEBY]: [...WRAPPED_NATIVE_ONLY[ChainId.RINKEBY], new Token(ChainId.RINKEBY, '0x1717A0D5C8705EE89A8aD6E808268D6A826C97A4', 6, 'USDC', 'USD Coin')],
    [ChainId.FANTOM]: [...WRAPPED_NATIVE_ONLY[ChainId.FANTOM], FANTOM.DAI, FANTOM.USDC, FANTOM.WBTC, FANTOM.WETH, FANTOM.MIM, FANTOM.FRAX, FANTOM.STG],
    [ChainId.BSC]: [...WRAPPED_NATIVE_ONLY[ChainId.BSC], BSC.DAI, BSC.USD, BSC.USDC, BSC.USDT, BSC.BTCB, BSC.WETH, BSC.MIM, BSC.FRAX, BSC.STG],
    [ChainId.ARBITRUM]: [...WRAPPED_NATIVE_ONLY[ChainId.ARBITRUM], ARBITRUM.WBTC, ARBITRUM.USDC, ARBITRUM.USDT, ARBITRUM.MIM, ARBITRUM.FRAX, ARBITRUM.STG],
    ...
    [ChainId.HARMONY]: [...WRAPPED_NATIVE_ONLY[ChainId.HARMONY], HARMONY.DAI, HARMONY.USDC, HARMONY.USDT, HARMONY.WBTC, HARMONY.WETH, HARMONY.FRAX],
    ...
    [ChainId.CELO]: [...WRAPPED_NATIVE_ONLY[ChainId.CELO], CELO.cETH, CELO.mCUSD, CELO.mCELO, CELO.mcEURO, CELO.cUSD, CELO.cEURO, CELO.cBTC, CELO.WETH, CELO.WBTC],
    [ChainId.MOONRIVER]: [...WRAPPED_NATIVE_ONLY[ChainId.MOONRIVER], MOONRIVER.USDC, MOONRIVER.USDT, MOONRIVER.WETH, MOONRIVER.FRAX, MOONRIVER.MIM, MOONRIVER.BTC, MOONRIVER.ROME],
    ...
    [ChainId.MOONBEAM]: [...WRAPPED_NATIVE_ONLY[ChainId.MOONBEAM], MOONBEAM.USDC, MOONBEAM.USDT, MOONBEAM.UST, MOONBEAM.WETH, MOONBEAM.WBTC, MOONBEAM.FRAX],
    [ChainId.OPTIMISM]: [...WRAPPED_NATIVE_ONLY[ChainId.OPTIMISM], OPTIMISM.USDC, OPTIMISM.USDT, OPTIMISM.DAI, OPTIMISM.WBTC, OPTIMISM.LUSD],
};
...
export const COMMON_BASES: ChainTokenList = {
    ...
    [ChainId.MATIC]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC], SUSHI[ChainId.MATIC], MATIC.WETH, MATIC.WBTC, MATIC.MIM, MATIC.ICE, MATIC.USDC, MATIC.USDT, MATIC.DAI, MATIC.FRAX, MATIC.STG],
    [ChainId.FANTOM]: [...WRAPPED_NATIVE_ONLY[ChainId.FANTOM], SUSHI[ChainId.FANTOM], FANTOM.WETH, FANTOM.WBTC, FANTOM.MIM, FANTOM.ICE, FANTOM.SPELL, FANTOM.USDC, FANTOM.DAI, FANTOM.FRAX, FANTOM.STG],
    [ChainId.BSC]: [...WRAPPED_NATIVE_ONLY[ChainId.BSC], SUSHI[ChainId.BSC], BSC.WETH, BSC.BTCB, BSC.MIM, BSC.SPELL, BSC.ICE, BSC.DAI, BSC.USDC, BSC.USDT, BSC.USD, BSC.FRAX, BSC.STG],
    [ChainId.ARBITRUM]: [...WRAPPED_NATIVE_ONLY[ChainId.ARBITRUM], SUSHI[ChainId.ARBITRUM], ARBITRUM.WBTC, ARBITRUM.MIM, ARBITRUM.SPELL, ARBITRUM.ICE, ARBITRUM.USDC, ARBITRUM.USDT, ARBITRUM.FRAX, ARBITRUM.STG],
    [ChainId.XDAI]: [...WRAPPED_NATIVE_ONLY[ChainId.XDAI], SUSHI[ChainId.XDAI], XDAI.WETH, XDAI.WBTC, XDAI.USDC, XDAI.USDT, XDAI.GNO],
    [ChainId.AVALANCHE]: [
        ...WRAPPED_NATIVE_ONLY[ChainId.AVALANCHE],
    ...
    [ChainId.HARMONY]: [...WRAPPED_NATIVE_ONLY[ChainId.HARMONY], SUSHI[ChainId.HARMONY], HARMONY.WBTC, HARMONY.WETH, HARMONY.USDC, HARMONY.USDT, HARMONY.DAI, HARMONY.FRAX],
    [ChainId.HECO]: [...WRAPPED_NATIVE_ONLY[ChainId.HECO], SUSHI[ChainId.HECO], HECO.WBTC, HECO.WETH, HECO.USDC, HECO.USDT, HECO.DAI],
    [ChainId.OKEX]: [...WRAPPED_NATIVE_ONLY[ChainId.OKEX], SUSHI[ChainId.OKEX], OKEX.WBTC, OKEX.WETH, OKEX.USDC, OKEX.USDT, OKEX.DAI],
    [ChainId.CELO]: [...WRAPPED_NATIVE_ONLY[ChainId.CELO], SUSHI[ChainId.CELO], CELO.WETH, CELO.WBTC, CELO.USDC, CELO.cUSD, CELO.cEURO],
    [ChainId.MOONRIVER]: [...WRAPPED_NATIVE_ONLY[ChainId.MOONRIVER], SUSHI[ChainId.MOONRIVER], MOONRIVER.WETH, MOONRIVER.BTC, MOONRIVER.MIM, MOONRIVER.FRAX, MOONRIVER.USDC, MOONRIVER.USDT, MOONRIVER.ROME],
    [ChainId.PALM]: [...WRAPPED_NATIVE_ONLY[ChainId.PALM], PALM.WETH, PALM.DAI],
    [ChainId.FUSE]: [...WRAPPED_NATIVE_ONLY[ChainId.FUSE], SUSHI[ChainId.FUSE], FUSE.WBTC, FUSE.WETH, FUSE.USDC, FUSE.USDT, FUSE.DAI],
    [ChainId.TELOS]: [...WRAPPED_NATIVE_ONLY[ChainId.TELOS], SUSHI[ChainId.TELOS], TELOS.WETH, TELOS.WBTC, TELOS.USDC, TELOS.USDT],
    [ChainId.MOONBEAM]: [...WRAPPED_NATIVE_ONLY[ChainId.MOONBEAM], MOONBEAM.USDC, MOONBEAM.USDT, MOONBEAM.UST, MOONBEAM.WETH, MOONBEAM.WBTC, MOONBEAM.FRAX],
    [ChainId.OPTIMISM]: [...WRAPPED_NATIVE_ONLY[ChainId.OPTIMISM], OPTIMISM.USDC, OPTIMISM.USDT, OPTIMISM.DAI, OPTIMISM.WBTC, OPTIMISM.LUSD],
};
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
    ...WRAPPED_NATIVE_ONLY,
    [ChainId.ETHEREUM]: [...WRAPPED_NATIVE_ONLY[ChainId.ETHEREUM], ETHEREUM.DAI, ETHEREUM.USDC, ETHEREUM.USDT, ETHEREUM.WBTC, ETHEREUM.OHM_V1, ETHEREUM.OHM_V2, ETHEREUM.MIM, ETHEREUM.FRAX, ETHEREUM.STG],
    [ChainId.MATIC]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC], MATIC.USDC, MATIC.WBTC, MATIC.MIM, MATIC.DAI, MATIC.WETH, MATIC.USDT, MATIC.FRAX, MATIC.STG],
    [ChainId.MATIC_TESTNET]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC_TESTNET], new Token(ChainId.MATIC_TESTNET, '0x742DfA5Aa70a8212857966D491D67B09Ce7D6ec7', 6, 'USDC', 'USD Coin')],
    [ChainId.RINKEBY]: [...WRAPPED_NATIVE_ONLY[ChainId.RINKEBY], new Token(ChainId.RINKEBY, '0x1717A0D5C8705EE89A8aD6E808268D6A826C97A4', 6, 'USDC', 'USD Coin')],
    [ChainId.FANTOM]: [...WRAPPED_NATIVE_ONLY[ChainId.FANTOM], FANTOM.DAI, FANTOM.USDC, FANTOM.WBTC, FANTOM.WETH, FANTOM.MIM, FANTOM.FRAX, FANTOM.STG],
    [ChainId.BSC]: [...WRAPPED_NATIVE_ONLY[ChainId.BSC], BSC.DAI, BSC.USD, BSC.USDC, BSC.USDT, BSC.BTCB, BSC.WETH, BSC.MIM, BSC.FRAX, BSC.STG],
    [ChainId.ARBITRUM]: [...WRAPPED_NATIVE_ONLY[ChainId.ARBITRUM], ARBITRUM.WBTC, ARBITRUM.USDC, ARBITRUM.USDT, ARBITRUM.MIM, ARBITRUM.gOHM, ARBITRUM.MAGIC, ARBITRUM.FRAX, ARBITRUM.STG],
    [ChainId.XDAI]: [...WRAPPED_NATIVE_ONLY[ChainId.XDAI], XDAI.USDC, XDAI.USDT, XDAI.WBTC, XDAI.WETH],
    [ChainId.AVALANCHE]: [
        ...WRAPPED_NATIVE_ONLY[ChainId.AVALANCHE],
    ...
    [ChainId.HECO]: [...WRAPPED_NATIVE_ONLY[ChainId.HECO], HECO.DAI, HECO.USDC, HECO.USDT, HECO.WBTC, HECO.WETH],
    [ChainId.OKEX]: [...WRAPPED_NATIVE_ONLY[ChainId.OKEX], OKEX.DAI, OKEX.USDC, OKEX.USDT, OKEX.WBTC, OKEX.WETH],
    [ChainId.CELO]: [...WRAPPED_NATIVE_ONLY[ChainId.CELO], CELO.cETH, CELO.mCUSD, CELO.mCELO, CELO.mcEURO, CELO.cUSD, CELO.cEURO, CELO.cBTC],
    [ChainId.MOONRIVER]: [...WRAPPED_NATIVE_ONLY[ChainId.MOONRIVER], MOONRIVER.USDC, MOONRIVER.USDT, MOONRIVER.WETH, MOONRIVER.FRAX, MOONRIVER.MIM, MOONRIVER.BTC, MOONRIVER.ROME],
    [ChainId.PALM]: [...WRAPPED_NATIVE_ONLY[ChainId.PALM], PALM.WETH, PALM.DAI],
    [ChainId.FUSE]: [...WRAPPED_NATIVE_ONLY[ChainId.FUSE], FUSE.USDC, FUSE.USDT, FUSE.WBTC, FUSE.WETH, FUSE.DAI],
    [ChainId.TELOS]: [...WRAPPED_NATIVE_ONLY[ChainId.TELOS], TELOS.USDC, TELOS.USDT, TELOS.WETH, TELOS.WBTC],
...
export const PINNED_PAIRS: { readonly [chainId: number]: [Token, Token][] } = {
    [ChainId.ETHEREUM]: [
        ...
        [new Token(ChainId.ETHEREUM, '0x5d3a536E4D6DbD6114cc1Ead35777bAB948E3643', 8, 'cDAI', 'Compound Dai'), new Token(ChainId.ETHEREUM, '0x39AA39c021dfbaE8faC545936693aC917d5E7563', 8, 'cUSDC', 'Compound USD Coin')],
